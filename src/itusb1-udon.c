/* ITUSB1 UDOn Command - Version 1.1 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    else  // If libusb is initialized
    {
        ...
        else  // If the device is successfully opened and a handle obtained
        {
            ...
            {
                set_gpio2(devhandle, false);  // Set GPIO.2 to a logical low in order to connect the data lines
                if (err_level == EXIT_SUCCESS)  // If all goes well
                    printf("USB data enabled.\n");
